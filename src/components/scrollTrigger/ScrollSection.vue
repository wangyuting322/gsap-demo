...
const goToSection = async (i) => {
  ...
  await nextTick()
  ctx.add(() => {
    scrollTween = gsap.to(ScrollSection.value, {
      scrollTo: { y: i * 500, autoKill: false },
      duration: 1,
      id: 'scrollTween',
...
watch(
  [() => gsapStore.isLoaded, ScrollSection, main],
